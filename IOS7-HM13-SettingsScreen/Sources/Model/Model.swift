...
extension SetupSections {
    static var setupSections: [SetupSections] = [
        ...
        Setups(image: UIImage(systemName: "b.circle")!, name: "Bluetooth", color: .systemBlue, labelRight: "Вкл.", cellType: .labelCell),
        ...
        Setups(image: UIImage(systemName: "v.circle")!, name: "VPN", color: .systemBlue, cellType: .switchCell)]),
        ...
        Setups(image: UIImage(systemName: "moon.fill")!, name: "Экстренный вызов - SOS", color: UIColor.systemRed, cellType: .baseCell),
        Setups(image: UIImage(systemName: "circle.hexagongrid.circle.fill")!, name: "Уведомление о контакте", color: UIColor.systemRed, cellType: .baseCell),
